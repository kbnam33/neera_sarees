    ...
    return (
        ...
        <div className="bg-neera-bg min-h-screen pt-12 pb-16 font-sans">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-8">
                <h1 className="text-3xl font-serif text-center text-neera-accent mb-12">Shipping Policy</h1>
                <div className="space-y-8 text-neera-text">
                    <div>
                        <h2 className="text-xl font-serif text-neera-accent mb-4">Shipping within India</h2>
                    ...
                    <div>
                        <h2 className="text-xl font-serif text-neera-accent mb-4">International Shipping</h2>
                    ...
                    <div>
                        <h2 className="text-xl font-serif text-neera-accent mb-4">Order Tracking</h2>
